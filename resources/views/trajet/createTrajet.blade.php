 ...
 <section>
     ...
     <form class="flex flex-col space-y-2" action="/subscribe" method="POST">
         ...
         <input class="border-2 border-gray-500 border-solid p-1 placeholder:text-center" type="datetime" placeholder="heure de départ" value="{{ old('heureDepart') }}" name="heureDepart" id="">
         <input class="border-2 border-gray-500 border-solid p-1 placeholder:text-center" type="datetime" placeholder="heure d'arriver" value="{{ old('heureArriver') }}" name="heureArriver">
